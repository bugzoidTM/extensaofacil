...
export function StaticPage({ page }: { page: "sobre" | "autoria" | "privacidade" | "termos" }) {
  const copy = {
    ...
    autoria: { title: "Quem escreve o Extensão Fácil", description: "Como os conteúdos deste portal são produzidos, revisados e corrigidos.", eyebrow: "Autoria e método", sections: [
      ...
      { title: "O que não fazemos", text: "Não afirmamos regra de faculdade sem fonte, não publicamos estatística sem origem verificável, não descrevemos atividades reais de terceiros e não vendemos trabalhos prontos. Quando não temos uma resposta segura, dizemos isso na página em vez de preencher a lacuna. Indicações para a loja parceira Apostileiros, quando aparecem, vêm sempre identificadas como parceria." },
